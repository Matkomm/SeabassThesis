...
fig.suptitle('Path with Swimming Speed from a Fish in The Evening', fontsize=16)
...
plt.savefig(r'C:\Users\Mathiako\OneDrive - NTNU\Documents\Master Mathias\Figures\Autosaved\Path_Evening_speed.png', bbox_inches='tight')
plt.show()
